...
lazy_static! {
    ...
    static ref MIDDLE: BaseShape = BaseShape::new(ShapeKind::Ship, 1., 0.7, 0.33, MIDDLE_COLOR);
    static ref MIDDLE_DAMAGED: BaseShape = BaseShape::new(
    ...
    static ref PLATFORM_DAMAGED: BaseShape = BaseShape::new(
        ShapeKind::PlatformDamaged,
        1.,
        0.,
        0.,
        (0.5, 0.5, 0.9).into()
    );
    static ref PLATFORM_DESTROYED: BaseShape = BaseShape::new(
